...
-------Table copy 
CREATE TABLE "OG_Insp_2019_Makoni__OGOrg_1"  AS
TABLE "OG_Insp_2019_Makoni__OGOrg";


------------------  gender_text
ALTER TABLE "OG_Insp_2019_Makoni__OGOrg_1"
ADD COLUMN gender_text TEXT;

UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
SET gender_text = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Sex"
        WHEN 1 THEN 'male'
        WHEN 2 THEN 'female'
    END
);
...
UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
SET "household_head" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Household_head"
        WHEN 1 THEN 'husband'
        WHEN 2 THEN 'wife'
        WHEN 3 THEN 'mother'
        WHEN 4 THEN 'father'
...
ADD COLUMN "marital_status" TEXT;
 ...
 UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
 SET "marital_status" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Marital_status"
        WHEN 2 THEN 'married'
        WHEN 3 THEN 'single'
...
UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
SET "School_(fees)_expenditure" = CASE WHEN "School_(fees)_expenditure" = 'Worked at the school for fees' THEN '0' ELSE "School_(fees)_expenditure" END;
...
UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
SET "School_(fees)_expenditure" = 
  CASE 
    WHEN "School_(fees)_expenditure" = 'none' THEN '0' 
    ELSE REPLACE(REPLACE("School_(fees)_expenditure", '$', ''), 'USD', '') 
  END;
...
WHERE "OG_Insp_2019_Makoni__OGOrg_1"."ID" = "OG_Insp_2020__OGOrg"."ID";
...
-----------------Enough_cereal_2015,2016,2017,2018

ALTER TABLE "OG_Insp_2019_Makoni__OGOrg_1"
ALTER COLUMN "Enough_cereal_2018" TYPE text;
...
------------------Availabilty_of_HH_latrine
    ...
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Availabilty_of_HH_latrine"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END);
 ...
 --------------- latrine type 
        ...
        ALTER TABLE "OG_Insp_2019_Makoni__OGOrg_1"
      ALTER COLUMN "Latrine_Type" TYPE text;
                        
           
 
    UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
    SET "Latrine_Type" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Latrine_Type"
        WHEN '1' THEN 'No'
        WHEN '2' THEN 'BVIP'
        --WHEN '3' THEN 'Dam'
        WHEN '3' THEN 'Pit'
...
SET "Main_livelihood_activity" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Main_livelihood_activity"
...
SET "Main_source_of_HH_water" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Main_source_of_HH_water"
...
SET "HH_education_level" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."HH_education_level"
...
SET "Reason_for_not_attending" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Reason_for_not_attending"
...
ALTER TABLE "OG_Insp_2019_Makoni__OGOrg_1"
ALTER COLUMN "Insufficient_cereal_reason_3" TYPE text;
  


UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
SET "Insufficient_cereal_reason_1" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Insufficient_cereal_reason_1"
...
ALTER TABLE "OG_Insp_2019_Makoni__OGOrg_1"
ALTER COLUMN "Source_of_irrigation_water" TYPE text;
...
SET "Source_of_irrigation_water" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Source_of_irrigation_water"
        WHEN '1' THEN 'Borehole'
        WHEN '2' THEN 'Open well'
        WHEN '3' THEN 'Dam'
        WHEN '4' THEN 'Stream or river'
...
UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
SET "Type_of_stove" = (
    CASE "OG_Insp_2019_Makoni__OGOrg_1"."Type_of_stove"
...
SET "Health_of_Farmer" = CASE
             ...
             ----------------------
      UPDATE "OG_Insp_2019_Makoni__OGOrg_1"
     SET "last_quarter_food_expenditure" = REPLACE("last_quarter_food_expenditure", '.00', '')
...
DROP COLUMN "Distance_from_nearest_Shops";
     ...
     ALTER TABLE "OG_Insp_2019_Makoni__OGOrg_1"
DROP COLUMN "leadership_position_3";
