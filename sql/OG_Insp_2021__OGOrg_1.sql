...
SET "Marital_status" = (
    CASE "OG_Insp_2021__OGOrg_1"."Marital_status"
        WHEN '2' THEN 'married'
        WHEN '3' THEN 'single'
...
SELECT * 
FROM "OG_Insp_2021__OGOrg_1" cooo ;
-------
...
UPDATE "OG_Insp_2021__OGOrg_1"
SET "Sex" = (
    CASE "OG_Insp_2021__OGOrg_1"."Sex"
        WHEN '1' THEN 'male'
        WHEN '2' THEN 'female'
    END
);
...
UPDATE "OG_Insp_2021__OGOrg_1"
SET "Household_head" = (
    CASE "OG_Insp_2021__OGOrg_1"."Household_head"
        WHEN '1' THEN 'husband'
        WHEN '2' THEN 'wife'
        WHEN '3' THEN 'mother'
        WHEN '4' THEN 'father'
...
SET "HH_education_level" = (
    CASE "OG_Insp_2021__OGOrg_1"."HH_education_level"
...
SET "Reason_for_not_attending" = (
    CASE "OG_Insp_2021__OGOrg_1"."Reason_for_not_attending"
...
SET "Main_livelihood_activity" = (
    CASE "OG_Insp_2021__OGOrg_1"."Main_livelihood_activity"
...
UPDATE "OG_Insp_2021__OGOrg_1"
SET "Dry_land_income" = (
    CASE "OG_Insp_2021__OGOrg_1"."Dry_land_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Irrigated_income" = (
    CASE "OG_Insp_2021__OGOrg_1"."Irrigated_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET"Gardening_income" = (
    CASE "OG_Insp_2021__OGOrg_1"."Gardening_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Formal_employment_income" = (
    CASE "OG_Insp_2021__OGOrg_1"."Formal_employment_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Small_business_income" = (
    CASE "OG_Insp_2021__OGOrg_1"."Small_business_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Insufficient_cereal_reason_1" = (
    CASE "OG_Insp_2021__OGOrg_1"."Insufficient_cereal_reason_1"
...
SET "Insufficient_cereal_reason_2" = (
    CASE "OG_Insp_2021__OGOrg_1"."Insufficient_cereal_reason_2"
        WHEN '1' THEN 'Non affordability of fertilizer'
        WHEN '2' THEN 'Non Availability of fertilizer'
        WHEN '3' THEN 'Non Availability of Seed'
        WHEN '4' THEN 'Non Affordability of Seed'
...
SET "Insufficient_cereal_reason_3" = (
    CASE "OG_Insp_2021__OGOrg_1"."Insufficient_cereal_reason_3"
        WHEN '1' THEN 'Non affordability of fertilizer'
        WHEN '2' THEN 'Non Availability of fertilizer'
        WHEN '3' THEN 'Non Availability of Seed'
        WHEN '4' THEN 'Non Affordability of Seed'
...
UPDATE "OG_Insp_2021__OGOrg_1"
SET "Type_of_stove" = (
    CASE "OG_Insp_2021__OGOrg_1"."Type_of_stove"
...
SET "Main_source_of_HH_water" = (
    CASE "OG_Insp_2021__OGOrg_1"."Main_source_of_HH_water"
...
SET "Source_of_irrigation_water" = (
    CASE "OG_Insp_2021__OGOrg_1"."Source_of_irrigation_water"
        WHEN '1' THEN 'Borehole'
        WHEN '2' THEN 'Open well'
        WHEN '3' THEN 'Dam'
        WHEN '4' THEN 'Stream or river'
...
SET "Availabilty_of_HH_latrine" = (
    CASE "OG_Insp_2021__OGOrg_1"."Availabilty_of_HH_latrine"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
UPDATE "OG_Insp_2021__OGOrg_1"
SET "Latrine_Type" = (
    CASE "OG_Insp_2021__OGOrg_1"."Latrine_Type"
        WHEN '1' THEN 'No'
        WHEN '2' THEN 'BVIP'
        WHEN '3' THEN 'Dam'
        WHEN '4' THEN 'Pit'
...
SET "Membership_to_other_organisations" = (
    CASE "OG_Insp_2021__OGOrg_1"."Membership_to_other_organisations"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
 );
...
UPDATE "OG_Insp_2021__OGOrg_1"
SET "Organisation_3" = (
    CASE "OG_Insp_2021__OGOrg_1"."Organisation_3"
        WHEN '1' THEN 'CPC'
...
SET "leadership_position_3" = (
    CASE "OG_Insp_2021__OGOrg_1"."leadership_position_3"
...
SELECT * FROM  "OG_Insp_2021__OGOrg_1" ;


UPDATE "OG_Insp_2021__OGOrg_1"
SET "Training/inputs_recieved_3" = (
    CASE "OG_Insp_2021__OGOrg_1"."Training/inputs_recieved_3"
        WHEN '1' THEN 'Seed'
...
SET "Health_of_Farmer" = (
    CASE "OG_Insp_2021__OGOrg_1"."Health_of_Farmer"
        WHEN '1' THEN 'Good'
        WHEN '2' THEN 'Unwell'
...
SET "Risk_from_non_organic_fields" = (
    CASE "OG_Insp_2021__OGOrg_1"."Risk_from_non_organic_fields"
        WHEN '1' THEN 'Low'
        WHEN '2' THEN 'Medium'
        WHEN '3' THEN 'High'
        END
...
ALTER TABLE  "OG_Insp_2021__OGOrg_1"
alter COLUMN "cereal_harvest_last" type text ;
...
SET "cereal_harvest_last" = 
  CASE
    ...
    WHEN "Cereal_harvest_last" LIKE '% month%' THEN
...
SET "cereal_harvest_last" =
  CASE
    WHEN "cereal_harvest_last" = '0,5' THEN '0.5'
    ELSE "cereal_harvest_last"
  END
...
ALTER TABLE  "OG_Insp_2021__OGOrg_1"
alter COLUMN "cereal_harvest_last" type float USING "cereal_harvest_last"::FLOAT;

Health__care_expenditure
School_(fees)_expenditure
last_quarter_food_expenditure 

this is a bit difficult because of currencies and different ways of entering.  
...
SET "health_care_expenditure" =
 ...
 SELECT "Health__care_expenditure", "health_care_expenditure" FROM "OG_Insp_2021__OGOrg_1"; 
 SELECT * FROM "OG_Insp_2021__OGOrg_1"; 
...
WHERE "health_care_expenditure" LIKE '%RTGS%'; ---- RTGS rate IN 2019 was 13 RTGS : 1 USd. 
...
SET "school_fees_expenditure" =
 ...
 SELECT "School_(fees)_expenditure", "school_fees_expenditure" FROM "OG_Insp_2021__OGOrg_1";  ----CONTROL check
 SELECT * FROM "OG_Insp_2021__OGOrg_1"; 
...
SET "last_quarter_food_expenditure_1" =
 ...
 SELECT "last_quarter_food_expenditure", "last_quarter_food_expenditure_1" FROM "OG_Insp_2021__OGOrg_1"; 
 SELECT * FROM "OG_Insp_2021__OGOrg_1"; 
...
SET "Enough_cereal_2018" = (
    CASE "OG_Insp_2021__OGOrg_1"."Enough_cereal_2018"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2019" = (
    CASE "OG_Insp_2021__OGOrg_1"."Enough_cereal_2019"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2016" = (
    CASE "OG_Insp_2021__OGOrg_1"."Enough_cereal_2016"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2017" = (
    CASE "OG_Insp_2021__OGOrg_1"."Enough_cereal_2017"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
