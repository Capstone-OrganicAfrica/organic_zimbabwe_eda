CREATE TABLE "OG_Insp_2021_2__OGOrg_2"  AS
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA organic_africa TO alexandrapersina;
 ...
 GRANT UPDATE, SELECT, TRUNCATE, REFERENCES, DELETE, TRIGGER, INSERT ON TABLE organic_africa."OGInfo__OGMB_2" TO alexandrapersina, khatanzayaschmidt, tomislavilic;
...
SET "Marital_status" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Marital_status"
        WHEN '2' THEN 'married'
        WHEN '3' THEN 'single'
...
SELECT * 
FROM "OG_Insp_2021_2__OGOrg_2" cooo ;
-------
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Sex" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Sex"
        WHEN '1' THEN 'male'
        WHEN '2' THEN 'female'
    END
);
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Household_head" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Household_head"
        WHEN '1' THEN 'husband'
        WHEN '2' THEN 'wife'
        WHEN '3' THEN 'mother'
        WHEN '4' THEN 'father'
...
SET "HH_education_level" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."HH_education_level"
...
SET "Reason_for_not_attending" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Reason_for_not_attending"
...
SET "Main_livelihood_activity" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Main_livelihood_activity"
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Dry_land_income" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Dry_land_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Irrigated_income" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Irrigated_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET"Gardening_income" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Gardening_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Formal_employment_income" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Formal_employment_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Small_business_income" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Small_business_income"
        WHEN 1 THEN 25
        WHEN 2 THEN 50
        WHEN 3 THEN 75
        WHEN 4 THEN 100
...
SET "Insufficient_cereal_reason_2" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Insufficient_cereal_reason_2"
...
ALTER TABLE "OG_Insp_2021_2__OGOrg_2" 
ADD COLUMN insufficient_cereal_reason_3 TEXT;

UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Insufficient_cereal_reason_3" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Insufficient_cereal_reason_3"
        WHEN '1' THEN 'Non affordability of fertilizer'
        WHEN '2' THEN 'Non Availability of fertilizer'
        WHEN '3' THEN 'Non Availability of Seed'
        WHEN '4' THEN 'Non Affordability of Seed'
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Type_of_stove" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Type_of_stove"
...
SET "Main_source_of_HH_water" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Main_source_of_HH_water"
...
SET "Source_of_irrigation_water" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Source_of_irrigation_water"
        WHEN '1' THEN 'Borehole'
        WHEN '2' THEN 'Open well'
        WHEN '3' THEN 'Dam'
        WHEN '4' THEN 'Stream or river'
...
SET "Availabilty_of_HH_latrine" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Availabilty_of_HH_latrine"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2018" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Enough_cereal_2018"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2019" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Enough_cereal_2019"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2020" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Enough_cereal_2020"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
SET "Enough_cereal_2021" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Enough_cereal_2021"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
);
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Latrine_Type" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Latrine_Type"
        WHEN '1' THEN 'No'
        WHEN '2' THEN 'BVIP'
        WHEN '3' THEN 'Dam'
        WHEN '4' THEN 'Pit'
...
SET "Membership_to_other_organisations" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Membership_to_other_organisations"
        WHEN '1' THEN 'Yes'
        WHEN '2' THEN 'No'
        END
 );
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "organisation_1" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."organisation_1"
        WHEN '1' THEN 'CPC'
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Organisation_2" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Organisation_2"
        WHEN '1' THEN 'CPC'
        WHEN '2' THEN 'Save the Children'
        WHEN '3' THEN 'Social Welfare'
        WHEN '4' THEN 'ZUBO'
...
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Organisation_3" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Organisation_3"
        WHEN '1' THEN 'CPC'
        WHEN '2' THEN 'Save the Children'
        WHEN '3' THEN 'Social Welfare'
        WHEN '4' THEN 'ZUBO'
...
SET "Leadership_position_1" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Leadership_position_1"
...
SET "Leadership_postion_2" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Leadership_postion_2"
        WHEN '1' THEN 'Secretary'
        WHEN '2' THEN 'Chairperson'
        WHEN '3' THEN 'Deputy Chairperson'
        WHEN '4' THEN 'Member'
...
SET "leadership_position_3" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."leadership_position_3"
        WHEN '1' THEN 'Secretary'
        WHEN '2' THEN 'Chairperson'
        WHEN '3' THEN 'Deputy Chairperson'
        WHEN '4' THEN 'Member'
...
SELECT * FROM  "OG_Insp_2021_2__OGOrg_2" ;

UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "Training/inputs_recieved_1" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Training/inputs_recieved_1"
        WHEN '1' THEN 'Seed'
...
SET "Training/inputs_recieved_2" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Training/inputs_recieved_2"
        WHEN '1' THEN 'Seed'
        WHEN '2' THEN 'Seed and fertilizers'
        WHEN '3' THEN 'Farming equipment'
        WHEN '4' THEN 'Trainig'
...
SET "Training/inputs_recieved_3" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Training/inputs_recieved_3"
        WHEN '1' THEN 'Seed'
        WHEN '2' THEN 'Seed and fertilizers'
        WHEN '3' THEN 'Farming equipment'
        WHEN '4' THEN 'Trainig'
...
SET "Health_of_Farmer" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Health_of_Farmer"
        WHEN '1' THEN 'Good'
        WHEN '2' THEN 'Unwell'
...
SELECT "nearest_shops", "Distance_from_nearest_Shops" FROM "OG_Insp_2021_2__OGOrg_2" oio ;
...
SET "Risk_from_non_organic_fields" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Risk_from_non_organic_fields"
        WHEN '1' THEN 'Low'
        WHEN '2' THEN 'Medium'
        WHEN '3' THEN 'High'
        END
...
SET "Risk_from_non_organic_activities" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Risk_from_non_organic_activities"
        WHEN '1' THEN 'Low'
        WHEN '2' THEN 'Medium'
        WHEN '3' THEN 'High'
        END
...
SET "Risk_from_motorways,_wastewaters" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Risk_from_motorways,_wastewaters"
        WHEN '1' THEN 'Low'
        WHEN '2' THEN 'Medium'
        WHEN '3' THEN 'High'
        END
...
SET "Risk_of_contaminated_water" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Risk_of_contaminated_water"
        WHEN '1' THEN 'Low'
        WHEN '2' THEN 'Medium'
        WHEN '3' THEN 'High'
        END
...
SET "Risk_of_contamination_from_Malaria_control" = (
    CASE "OG_Insp_2021_2__OGOrg_2"."Risk_of_contamination_from_Malaria_control"
        WHEN '1' THEN 'Low'
        WHEN '2' THEN 'Medium'
        WHEN '3' THEN 'High'
        END
...
SELECT "cereal_harvest_last", "Cereal_harvest_last" FROM "OG_Insp_2021_2__OGOrg_2" ---CHECK what you did AND IF there IS still anything odd. 
...
SET "health_care_expenditure" =
 ...
 SELECT "Health__care_expenditure", "health_care_expenditure" FROM "OG_Insp_2021_2__OGOrg_2"; 
 SELECT * FROM "OG_Insp_2021_2__OGOrg_2"; 
...
UPDATE "OGInsp2021__OGMB_2" ----IF this does NOT WORK, try the one underneath
SET "school_fees_expenditure" = REPLACE(REPLACE("school_fees_expenditure", '$', ''), ' USD', '')
WHERE "School_(fees)_expenditure" LIKE '%$% USD';

 SELECT "School_(fees)_expenditure", "school_fees_expenditure" FROM "OG_Insp_2021_2__OGOrg_2";  ----CONTROL check
 SELECT * FROM "OG_Insp_2021_2__OGOrg_2"; 
...
ALTER TABLE "OG_Insp_2021_2__OGOrg_2" 
ADD COLUMN "last_quarter_food_expenditure_2" text

ALTER TABLE "OG_Insp_2021_2__OGOrg_2"
Alter COLUMN "last_quarter_food_expenditure_2" type float USING "last_quarter_food_expenditure_2"::float;

ALTER TABLE "OG_Insp_2021_2__OGOrg_2"
Alter COLUMN "last_quarter_food_expenditure_2" type text;


UPDATE "OGInsp2021__OGMB_2" ---might NOT WORK because OF TYPES, THEN try NEXT one
SET "last_quarter_food_expenditure_2" = REPLACE(REPLACE("last_quarter_food_expenditure_2", '$', ''), ' USD', '')
WHERE "last_quarter_food_expenditure" LIKE '%$% USD';

UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "last_quarter_food_expenditure_2" =
  CASE
    ...
    WHEN "last_quarter_food_expenditure" LIKE '%RTGS%' THEN (FLOOR(REGEXP_REPLACE("last_quarter_food_expenditure_2", '[^0-9]', '', 'g')::FLOAT / 13))::TEXT
    ELSE "last_quarter_food_expenditure"
  END;
   

 SELECT "last_quarter_food_expenditure", "last_quarter_food_expenditure_2" FROM "OG_Insp_2021_2__OGOrg_2"; 
 SELECT * FROM "OG_Insp_2021_2__OGOrg_2"; 
 
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "last_quarter_food_expenditure_2" = REPLACE("last_quarter_food_expenditure_2", 'usd', '') ---replacing the USD thats LEFT OVER FOR SOME reason. 
WHERE "last_quarter_food_expenditure" LIKE '%usd%';
 
UPDATE "OG_Insp_2021_2__OGOrg_2"
SET "last_quarter_food_expenditure_2" = (FLOOR(REGEXP_REPLACE("last_quarter_food_expenditure_2", '[^0-9]', '', 'g')::FLOAT / 13))::TEXT
WHERE "last_quarter_food_expenditure" LIKE '%RTGS%'; ---- RTGS rate IN 2019 was 13 RTGS : 1 USd. 
 
SELECT * FROM "OG_Insp_2021_2__OGOrg_2"


DROP TABLE "OG_Insp_2021_2__OGOrg_1"
